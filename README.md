...
**Tables auto-save** as you work (records, columns, business context). On Vercel, connect **Supabase** for permanent server storage (API keys + tables). See [docs/SUPABASE.md](docs/SUPABASE.md).
